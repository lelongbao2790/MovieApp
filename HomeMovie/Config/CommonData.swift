...
enum TypeMovies {
    ...
    var TagKeys: Array<String>{
        ...
        case .Hot:
            return Array(Tag.hot.keys)
        }
    }
    
    var titleTypeMovies: String {
        switch self {
        case .Feature:
            return "Movies"
        case .Television:
    ...
    static let allTypeMovies = [Hot, Feature, Television]
